    ...
    <div className="product flex flex-col gap-2 rounded-xl bg-white shadow-md overflow-hidden hover:shadow-2xl duration-300">
      ...
      <div className="texts flex flex-col gap-2 px-6 pb-5">
        ...
        <div className="flex justify-between items-center">
          ...
          <button className="cart-btn uppercase bg-violet-500 text-violet-50 font-medium py-3 px-8 rounded-md hover:bg-red-500 hover:text-orange-50 duration-300 shadow-violet-300 shadow-lg hover:shadow-orange-300">
            Add to cart
          </button>
        </div>
      </div>
